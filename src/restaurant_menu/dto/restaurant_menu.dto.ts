...
export class Restaurant_menuDto {
  @ApiProperty({
  ...
  @ApiProperty({
    example: 'RES12345',
    description: 'UID of the restaurant (optional if logged in)',
    required: false,
  })
  @IsOptional()
  @IsString()
  ...
  @ApiProperty({
    ...
    required: false,
    description: 'Customization options for the dish',
  })
  @IsOptional()
  ...
  @ApiProperty({
    example: [
      { name: 'Customize option', price: 50 },
      { name: 'Add Egg', price: 20 },
    ],
    required: false,
    description: 'Customization options for the dish',
  ...
  @ApiProperty({
    example: 124,
    required: false,
    description: 'How many times this item has been ordered',
  })
  @IsOptional()
  @IsInt()
  orderedCount?: number;
